...
מהנתונים, עלה בעץ ה-$B^+$  יכיל 5 ערכים, 20 בתים כל אחד והתפוסה היא 62.5% . נקבל גודל עלה ע"י פתרון המשוואה
\begin{align*}
    0.625 \cdot x &= 5 \cdot 20 \\
    x &= \frac{100}{0.625} \\
    x &= 160 
\end{align*}
כלומר, גודל עלה, ודף, הוא 160 בתים.
...
\end{align*}
 ...
 לכן נקבל כי $n=7$ משמע שיהיו בין 4 ל-6 ערכים בצומת. 

השורש יחזיק את הערכים  $(X_2, X_3, X_4, X_5)$ כאשר הרמה הבאה תהיינה דרגת העלים.
