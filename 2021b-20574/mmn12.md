...
נחשב את נפח האחסון של האינדקס 
 ...
 כל עלה בעץ האינדקס מחזיק ערך של $A_1$ ועוד 4 מצביעים, כלומר 20 בתים ולכן בדף יהיו $\lfloor \frac{4096}{20} \rfloor = 204$ עלים. נדרשים לנו $10^8$ עלים ולכן העלים לבדם יתפסו $\lceil \frac{10^8}{204} \rceil = 490197$ דפים לאחסון העלים.

 בנוסף, בהנחה שנרצה שגודל צומת פנימי בעץ יתפוס כמה שיותר מגודל דף, נחשב את ה-n האופטימלי ע"י אי-השוויון
\begin{align*}
    (n-1) \cdot 4 + 4n &\leq 4096 \\
    8n &\leq 4100 \\
    n &\leq 512.5 
\end{align*}
אז n אופטימלי הוא 512. על מנת לחשב את תוכן העץ בממוצע, ונניח תפוסה של 85%, ולכן כל צומת ביניים יצביע על $0.85 \cdot = 435$ ילדים.

נחשב את סך הצמתים, מהשכבה התחונה לעליונה

1. 100000000 עלים
2. $\lceil \frac{100000000}{435} \rceil = 229886$ צמתי ביניים
3. $\lceil \frac{229886}{435} \rceil = 529$ צמתי ביניים
4. $\lceil \frac{529}{435} \rceil = 2$ צמתי ביניים 
5. שורש

אם כן, בעץ יש $10^8$ עלים ובנוסף $229886 + 529 + 2 + 1 = 230418$ צמתי ביניים. מהגדרת n צומת ביניים יחיד תופס דף שלם ולכן, התפוסה בדפים של כל האינדקס היא 490197 + 230418 = 720615$ דפים.

לבסוף, סה"כ נפח איחסון הקובץ בדפים הוא סכום

- 720615 דפים לאיחסון האינדקס
...
כיוון שגודל עלה כגודל דף - 4010 בתים, וגודל רשומה הוא 40 בתים, נכנסות 100 רשומות בעלה. סה"כ הרשומות ביחס הוא $10^8$ לכן יהיו באינדקס $\frac{10^8}{10^2}=10^6$ עלים.

סך הצמתים בעץ, מרמת העלים תחילה

1. $10^6$
2. $\lceil \frac{10^6}{80} \rceil = 12500$
3. $\lceil \frac{12500}{80} \rceil = 157$
4. $\lceil \frac{157}{80} \rceil = 2$
5. $\lceil \frac{2}{80} \rceil = 1$

כלומר, $10^6 + 12500 + 157 + 2 + 1 = 1012660$ צמתים. כל צומת תופס דף, ולכן זהו מספר הדפים של האינדקס.
