 ...
 * 
 * Changes
 * - NDIRECT changed from 12 to 11 to add room for the double indirection
 * - MAXFILE changed to take to new blocks into account.
 *           due to adding another layer of indirection
 */
